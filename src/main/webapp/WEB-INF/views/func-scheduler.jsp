...
<body>
		...
		<div class="page-wrapper border-box-mode" style="padding: 0;">
			...
			<div class="col-main">
				<div class="func-title-wrapper">
					<i class="icon trs-all fa fa-bell"></i>
					<div class="fl">
						<p class="title">日程安排</p>
						<span class="desc">
							<c:if test="${weChatActivity.fScheduler == true}">
								已开通
							</c:if>
							<c:if test="${weChatActivity.fScheduler == false}">
								未开通
							</c:if>
						</span>
					</div>
									...
									<td width="100">
										<div style="margin-bottom: 1em;">
											<a class="ui-btn trs-all open-target" style="margin-bottom:5px"
												...
												"noticeTime": "<fmt:formatDate value="${weActivityScheduler.noticeTime }" type="time" timeStyle="full" pattern="yyyy-MM-dd HH:mm" />",
											...
											<a class="ui-btn trs-all"
												href="${ctx }/func/del_sch?activityMid=${weChatActivity.activityMid }&schedulerId=${weActivityScheduler.id }">删除</a>
										</div>
									</td>
								</tr>
							</c:forEach>
	...
	<div class="dialog trs-all" id="add-scheduler-dialog" style="width: 700px">
		...
		<div class="body">
			<form id="scheduler-form" method="post" action="${ctx }/func/sch">
